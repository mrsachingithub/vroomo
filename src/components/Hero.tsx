  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto mb-10 animate-slide-up" style={{
          animationDelay: "0.1s"
        }}>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap gap-6 mt-12 justify-center animate-slide-up" style={{
          animationDelay: "0.3s"
        }}>
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 pt-12 border-t border-white/10 animate-slide-up" style={{
        animationDelay: "0.4s"
      }}>
